...
{
	// Modules
	Modules::Client = game::search.wait_on_mod_handle("client_panorama.dll");
...
#pragma endregion Contains the VTable Indexs
	...
	// Do some dirty shit
	Functions::KeyValues_KeyValues = game::search.pattern("client_panorama.dll", (PBYTE)"\x68\x00\x00\x00\x00\x8B\xC8\xE8\x00\x00\x00\x00\x89\x45\xFC\xEB\x07\xC7\x45\x00\x00\x00\x00\x00\x8B\x03\x56", "x????xxx????xxxxxxx?????xxx");
	...
	Functions::dwCalcPlayerView =  game::search.pattern("client_panorama.dll", (PBYTE)"\x84\xC0\x75\x08\x57\x8B\xCE\xE8\x00\x00\x00\x00\x8B\x06", "xxxxxxxx????xx");
}
