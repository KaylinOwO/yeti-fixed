...
public:
	inline short* GetItemDefinitionIndex() {
		...
		static short it = GET_NETVAR("DT_BaseAttributableItem", "m_iItemDefinitionIndex");
		return (short*)((DWORD)this + it);
	}
	inline int* GetItemIDHigh() {
		static int it = GET_NETVAR("DT_BaseAttributableItem", "m_iItemIDHigh");
		return (int*)((DWORD)this + it);
	}
	inline int* GetAccountID() {
		static int it = GET_NETVAR("DT_BaseCombatWeapon", "m_iAccountID");
		return (int*)((DWORD)this + it);
	}
	inline int* GetEntityQuality() {
		static int it = GET_NETVAR("DT_BaseAttributableItem", "m_iEntityQuality");
		return (int*)((DWORD)this + it);
	}
	...
	inline int* GetOriginalOwnerXuidLow() {
		static int it = GET_NETVAR("DT_BaseAttributableItem", "m_OriginalOwnerXuidLow");
		return (int*)((DWORD)this + it);
	}
	inline int* GetOriginalOwnerXuidHigh() {
		static int it = GET_NETVAR("DT_BaseAttributableItem", "m_OriginalOwnerXuidHigh");
		return (int*)((DWORD)this + it);
	}
	inline int* GetFallbackPaintKit() {
		static int it = GET_NETVAR("DT_BaseAttributableItem", "m_nFallbackPaintKit");
		return (int*)((DWORD)this + it);
	}
	inline int* GetFallbackSeed() {
		static int it = GET_NETVAR("DT_BaseAttributableItem", "m_nFallbackSeed");
		return (int*)((DWORD)this + it);
	}
	inline float* GetFallbackWear() {
		static int it = GET_NETVAR("DT_BaseAttributableItem", "m_flFallbackWear");
		return (float*)((DWORD)this + it);
	}
	inline int* GetFallbackStatTrak() {
		static int it = GET_NETVAR("DT_BaseAttributableItem", "m_nFallbackStatTrak");
		return (int*)((DWORD)this + it);
	}
