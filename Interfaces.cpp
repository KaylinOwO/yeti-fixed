...
{
	InterfaceManager ClientManager( "client_panorama.dll" );
	...
	m_pInput = *( CInput** )(game::search.signature("client_panorama.dll", "B9 ? ? ? ? F3 0F 11 04 24 FF 50 10") + 1);
	...
	m_pGlowObjManager = *( CGlowObjectManager** )( game::search.signature( "client_panorama.dll", "0F 11 05 ? ? ? ? 83 C8 01" ) + 3 );
	...
	char* CHLClientInterfaceName = (char*)game::search.text_pattern("client_panorama.dll", "VClient0");
	...
	char* EntityListInterfaceName = (char*)game::search.text_pattern("client_panorama.dll", "VClientEntityList0");
	...
	char* ClientPredictionInterface = (char*)game::search.text_pattern("client_panorama.dll", "VClientPrediction0");
	...
	char* PhysPropsInterfaces = (char*)game::search.text_pattern("client_panorama.dll", "VPhysicsSurfaceProps0");
